...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "Maxx")
DATABASE_NAME = environ.get('DATABASE_NAME', "mongodb+srv://Maxx:Maxx@cluster0.se0izyv.mongodb.net/?retryWrites=true&w=majority")
